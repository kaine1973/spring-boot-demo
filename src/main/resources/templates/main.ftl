                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="header-logo col-auto">
                        <a href="main.ftl">
                            ...
                            <img src="/images/logo/logo-light.png" class="logo-light" alt="">
                        </a>
                            ...
                            <div class="col-auto">
                                ...
                                <ul class="header-notification-area">
                                    ...
                                    <li class="adomx-dropdown position-relative col-auto">
                                        <a class="toggle" href="#"><img class="lang-flag" src="/images/flags/flag-1.jpg" alt=""><i class="zmdi zmdi-caret-down drop-arrow"></i></a>
                                        ...
                                        <div class="adomx-dropdown-menu dropdown-menu-mail">
                                            ...
                                            <div class="body custom-scroll">
                                                <ul>
                                                    <li>
                                                        <a href="#">
                                                            <div class="image"><img src="/images/avatar/avatar-2.jpg" alt=""></div>
                                                            <div class="content">
                    ...
                    <ul>
                        <li class="has-sub-menu"><a href="#"><i class="ti-home"></i> <span>Dashboard</span></a>
                            <ul class="side-header-sub-menu">
                                <li><a href="javascript:addContent('/dashboard')" ><span>E-commerce (Default)</span></a></li>
                                <li><a href="javascript:addContent('/chartChartjs')"><span>Cryptocurrency</span></a></li>
                            </ul>
                        </li>
