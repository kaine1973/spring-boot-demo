                    ...
                    <div class="chat-app-wrap">
                        ...
                        <div class="chat-contacts">
                            ...
                            <ul class="chat-contact-list custom-scroll">
                                <li>
                                    <a href="#">
                                        <div class="image"><img src="/images/comment/comment-1.jpg" alt=""><span class="status online"></span></div>
                                        <div class="content">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="image"><img src="/images/comment/comment-2.jpg" alt=""><span class="status online"></span></div>
                                        <div class="content">
                                            <h5 class="name">Rebecca Mitchell</h5>
                                            <p class="last-message">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="image"><img src="/images/comment/comment-3.jpg" alt=""><span class="status online"></span></div>
                                        <div class="content">
                                            <h5 class="name">Rebecca Mitchell</h5>
                                            <p class="last-message">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="image"><img src="/images/comment/comment-4.jpg" alt=""><span class="status online"></span></div>
                                        <div class="content">
                                            <h5 class="name">Rebecca Mitchell</h5>
                                            <p class="last-message">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="image"><img src="/images/comment/comment-5.jpg" alt=""><span class="status online"></span></div>
                                        <div class="content">
                                            <h5 class="name">Rebecca Mitchell</h5>
                                            <p class="last-message">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="image"><img src="/images/comment/comment-6.jpg" alt=""><span class="status online"></span></div>
                                        <div class="content">
                                            <h5 class="name">Rebecca Mitchell</h5>
                                            <p class="last-message">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="image"><img src="/images/comment/comment-7.jpg" alt=""><span class="status online"></span></div>
                                        <div class="content">
                                            <h5 class="name">Rebecca Mitchell</h5>
                                            <p class="last-message">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="image"><img src="/images/comment/comment-8.jpg" alt=""><span class="status online"></span></div>
                                        <div class="content">
                                            <h5 class="name">Rebecca Mitchell</h5>
                                            <p class="last-message">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="image"><img src="/images/comment/comment-9.jpg" alt=""><span class="status online"></span></div>
                                        <div class="content">
                                            <h5 class="name">Rebecca Mitchell</h5>
                                            <p class="last-message">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                        </div>
                            ...
                            <ul class="chat-list">
                                <li>
                                    <div class="chat">
                                        ...
                                        <div class="body">
                                            <div class="image"><img src="/images/comment/comment-1.jpg" alt=""></div>
                                            <div class="content">
                                ...
                                <li>
                                    <div class="chat">
                                        ...
                                        <div class="body">
                                            <div class="image"><img src="/images/comment/comment-2.jpg" alt=""></div>
                                            <div class="content">
                                ...
                                <li>
                                    <div class="chat">
                                        ...
                                        <div class="body">
                                            <div class="image"><img src="/images/comment/comment-3.jpg" alt=""></div>
                                            <div class="content">
