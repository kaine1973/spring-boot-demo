            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3 class="title">Widgets <span>/ Widgets</span></h3>
                    </div>
            ...
            <div class="row mbn-30">
                                ...
                                <ul class="widget-chat-list">
                                    <li>
                                        <div class="widget-chat">
                                            ...
                                            <div class="body">
                                                <div class="image"><img src="/static/images/comment/comment-1.jpg" alt=""></div>
                                                <div class="content">
                                    ...
                                    <li>
                                        <div class="widget-chat">
                                            ...
                                            <div class="body">
                                                <div class="image"><img src="/static/images/comment/comment-2.jpg" alt=""></div>
                                                <div class="content">
                                    ...
                                    <li>
                                        <div class="widget-chat">
                                            ...
                                            <div class="body">
                                                <div class="image"><img src="/static/images/comment/comment-3.jpg" alt=""></div>
                                                <div class="content">
                ...
                <div class="col-xlg-4 col-lg-6 col-md-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <h5 class="text-body fw-400 m-0">Report of Currency</h5>
                ...
                <div class="col-xlg-4 col-lg-6 col-md-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <h5 class="text-body fw-400 m-0">Rate/usd</h5>
                ...
                <div class="col-md-12 mb-30">
                    <div class="box">
                        <div class="box-head">
                            <h4 class="title">Manage Product List</h4>
                        </div>
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table table-vertical-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>#MSP40022</td>
                                            <td><img src="/static/images/product/list-product-1.jpg" alt="" class="product-image rounded-circle"></td>
                                        ...
                                        <tr>
                                            <td>#MSP40023</td>
                                            <td><img src="/static/images/product/list-product-2.jpg" alt="" class="product-image rounded-circle"></td>
                                            <td><a href="#">Spro 4 Laptop</a></td>
                                            <td>$600.00</td>
                                            <td>03</td>
                                            <td>12</td>
                                        ...
                                        <tr>
                                            <td>#MSP40024</td>
                                            <td><img src="/static/images/product/list-product-3.jpg" alt="" class="product-image rounded-circle"></td>
                                            <td><a href="#">Spro 4 Laptop</a></td>
                                            <td>$600.00</td>
                                            <td>03</td>
                                            <td>12</td>
                                        ...
                                        <tr>
                                            <td>#MSP40025</td>
                                            <td><img src="/static/images/product/list-product-4.jpg" alt="" class="product-image rounded-circle"></td>
                                            <td><a href="#">Spro 4 Laptop</a></td>
                                            <td>$600.00</td>
                                            <td>03</td>
                                            <td>12</td>
                                        ...
                                        <tr>
                                            <td>#MSP40026</td>
                                            <td><img src="/static/images/product/list-product-5.jpg" alt="" class="product-image rounded-circle"></td>
                                            <td><a href="#">Spro 4 Laptop</a></td>
                                            <td>$600.00</td>
                                            <td>03</td>
                                            <td>12</td>
