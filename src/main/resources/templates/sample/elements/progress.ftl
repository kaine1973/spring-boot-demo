                ...
                <div class="col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <p class="mt-15">For more Information please follow the <a class="text-primary" href="https://getbootstrap.com/docs/4.3/components/pagination/">Official Documentation</a></p>
                        </div>
                    </div>
                </div>
                <!--How To Use End-->
