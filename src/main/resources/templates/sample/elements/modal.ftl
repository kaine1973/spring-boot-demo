            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <button class="button button-primary" data-toggle="modal" data-target="#exampleModal2">Launch modal</button>
                            <!-- Modal -->
                ...
                <div class="col-lg-6 col-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <button class="button button-primary" data-toggle="modal" data-target="#exampleModal3">Launch modal</button>
                            <!-- Modal -->
                ...
                <div class="col-lg-6 col-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <button class="button button-primary" data-toggle="modal" data-target="#exampleModal4">Launch modal</button>
                            <!-- Modal -->
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p>This <a href="#" class="button button-secondary" data-toggle="popover" title="Popover title" data-content="Popover body content is set in this attribute.">button</a> triggers a popover on click.</p>
                                            <hr>
                                            <h5>Tooltips in a modal</h5>
                                            <p><a href="#" class="text-primary" data-toggle="tooltip" title="Tooltip">This link</a> and <a href="#" class="text-primary" data-toggle="tooltip" title="Tooltip">that link</a> have tooltips on hover.</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button class="button button-danger" data-dismiss="modal">Close</button>
                                            <button class="button button-primary">Save changes</button>
                ...
                <div class="col-lg-6 col-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <button class="button button-primary" data-toggle="modal" data-target="#exampleModal6">Extra Large</button>
                            <button class="button button-primary" data-toggle="modal" data-target="#exampleModal7">Large</button>
                            <button class="button button-primary" data-toggle="modal" data-target="#exampleModal8">Small</button>
                            <!-- Modal -->
