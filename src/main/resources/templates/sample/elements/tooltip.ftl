            ...
            <div class="row">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="buttons-inline">
                                <button class="button button-primary" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Tooltip top</button>
                                <button class="button button-primary" data-toggle="tooltip" data-placement="right" title="Tooltip on right">Tooltip right</button>
                                <button class="button button-primary" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">Tooltip bottom</button>
                                <button class="button button-primary" data-toggle="tooltip" data-placement="left" title="Tooltip on left">Tooltip left</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="buttons-inline">
                                <button class="button button-primary" data-toggle="popover" data-container="body" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Popover top</button>
                                <button class="button button-primary" data-toggle="popover" data-container="body" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Popover right</button>
                                <button class="button button-primary" data-toggle="popover" data-container="body" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Popover bottom</button>
                                <button class="button button-primary" data-toggle="popover" data-container="body" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Popover left</button>
                            </div>
                        </div>
                    </div>
                </div>
