            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <video poster="/static/images/bg/video-1-poster.jpg" class="plyr-video" playsinline controls>
                                <source src="/media/video-1-576p.mp4" type="video/mp4" data-res="576" />
                                <source src="/media/video-1-720p.mp4" type="video/mp4" data-res="720" />
                                <source src="/media/video-1-1080p.mp4" type="video/mp4" data-res="1080" />
                            </video>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <audio class="plyr-audio" controls>
                                <source src="/media/audio-1.mp3" type="audio/mp3" />
                            </audio>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <code>
                            &lt;video poster="/images/bg/video-1-poster.jpg" class="plyr-video" playsinline controls&gt;<br />&nbsp;&nbsp;&nbsp; &lt;source src="/media/video-1-576p.mp4" type="video/mp4" size="576" /&gt;<br />&nbsp;&nbsp;&nbsp; &lt;source src="/media/video-1-720p.mp4" type="video/mp4" size="720" /&gt;<br />&nbsp;&nbsp;&nbsp; &lt;source src="/media/video-1-1080p.mp4" type="video/mp4" size="1080" /&gt;<br />&lt;/video&gt;
                        </code>
